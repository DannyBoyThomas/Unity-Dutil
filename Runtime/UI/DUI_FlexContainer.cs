...
namespace Dutil
{
    ...
    public class DUI_FlexContainer : DUI_Rect
    {
        public FlexAxis axis = FlexAxis.Horizontal;
        ...
        public override void Calculate()
        {
            ...
            for (int i = 0; i < chidlren.Count; i++)
            {
                ...
                {
                    float childHeight = ((GetHeight() - spaceLost) / totalFlex) * childFlex;
        ...
        List<RectTransform> GetChildren()
        {
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                DUI_Rect cantHave = axis == FlexAxis.Horizontal ? (DUI_Rect)child.GetComponent<DUI_Width>() : (DUI_Rect)child.GetComponent<DUI_Height>();
    ...
    public enum FlexAxis { Horizontal, Vertical }
}